...
const MixedWidget8: FC<Props> = ({className, chartColor, chartHeight, dropdownType='Dropdown1'}) => {
  ...
  // const selectedDropdown = dropdownType == 'Dropdown1' ? <Dropdown1 /> : <Dropdown4 />
    ...
    <div className={`card ${className}`}>
      ...
      <div className='card-header border-0 py-5'>
        ...
        <div className='card-toolbar'>
          ...
          {
            dropdownType === 'Dropdown1' ? <Dropdown1 /> : <Dropdown4 />
          }
          {/* end::Menu */}
        </div>
      </div>
